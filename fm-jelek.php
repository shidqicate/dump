...
$auth_users = array(
    'admin' => '$2y$10$dkmbZn.wEoD7MazR3UIYiOS26S4Tx45/vZ5.reioVw.YRUYodP7CG', //admin@123
);
...
if(isset($_GET['p']) && $_GET['p'] == "") {
    fm_redirect(FM_SELF_URL . '?p=' . getcwd());
}
...
if ($use_auth) {
    if (isset($_SESSION[FM_SESSION_ID]['logged'], $auth_users[$_SESSION[FM_SESSION_ID]['logged']])) {
        // Logged
    } elseif (isset($_POST['fm_pwd'], $_POST['token'])) {
        // Logging In
        sleep(1);
        if (function_exists('password_verify')) {
            if (isset($_POST['fm_pwd']) && password_verify($_POST['fm_pwd'], $auth_users['admin']) && verifyToken($_POST['token'])) {
...
?>
    <form action="" method="POST">
        ...
        <input type="password" name="fm_pwd" style='outline: none; border: none'>
    </form>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p>
                        <h3><a href="#" target="_blank" class="app-v-title"> Tiny File Manager <?php echo VERSION; ?></a></h3>
                        </p>
                    ...
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><a href="#filemanager/wiki" target="_blank"><i class="fa fa-question-circle"></i> <?php echo lng('Help Documents') ?> </a> </li>
                                <li class="list-group-item"><a href="#filemanager/issues" target="_blank"><i class="fa fa-bug"></i> <?php echo lng('Report Issue') ?></a></li>
                                <?php if (!FM_READONLY) { ?>
